(define (problem contenedores_almacen_ocho_vagones)
    ...
    ;Ocho vagones en el tren:
    v1 v2 v3 v4 v5 v6 v7 v8 - vagon
    )
    ...
    (vagon_en_tren tren v5)
    (vagon_en_tren tren v6)
    (vagon_en_tren tren v7)
    (vagon_en_tren tren v8)
